 ...
 */
@Api(name = "messageEndpoint",version="v4", namespace = @ApiNamespace(ownerDomain = "snoozi.com", ownerName = "snoozi.com", packagePath=""))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyDoqFj7_sHvr_RpJ8HFf_yNTSoaOYVioyU";
