...
@Api(name = "deviceinfoendpoint",version="v3", namespace = @ApiNamespace(ownerDomain = "snoozi.com", ownerName = "snoozi.com", packagePath = ""))
public class DeviceInfoEndpoint {
	...
	public void removeDeviceInfo(@Named("id") String id) {
		PersistenceManager mgr = getPersistenceManager();
		try {
			DeviceInfo deviceinfo = mgr.getObjectById(DeviceInfo.class, id);
	...
	private boolean containsDeviceInfo(DeviceInfo deviceinfo) {
		...
		try {
			mgr.getObjectById(DeviceInfo.class,
