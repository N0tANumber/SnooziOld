...
@Api(name = "videoendpoint",version="v4", namespace = @ApiNamespace(ownerDomain = "snoozi.com", ownerName = "snoozi.com", packagePath = ""))
public class VideoEndpoint {
	...
	public Video insertVideo(Video video) {
		...
		try {
			...
			// When adding a video, we take the server timestamp
