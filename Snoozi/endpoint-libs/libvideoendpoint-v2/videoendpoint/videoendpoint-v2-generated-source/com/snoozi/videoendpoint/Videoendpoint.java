...
public class Videoendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public GetVideo getVideo(java.lang.String id) throws java.io.IOException {
  ...
  public class GetVideo extends VideoendpointRequest<com.snoozi.videoendpoint.model.Video> {
     ...
     * @since 1.13
     */
    protected GetVideo(java.lang.String id) {
    ...
    public GetVideo setId(java.lang.String id) {
      this.id = id;
      return this;
    }
   ...
   * @return the request
   */
  public RemoveVideo removeVideo(java.lang.String id) throws java.io.IOException {
  ...
  public class RemoveVideo extends VideoendpointRequest<Void> {
     ...
     * @since 1.13
     */
    protected RemoveVideo(java.lang.String id) {
    ...
    public RemoveVideo setId(java.lang.String id) {
      this.id = id;
      return this;
    }
