...
/**
 * Service definition for Videoendpoint (v4).
 *
 * <p>
 * This is an API
 * </p>
...
public class Videoendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.18.0-rc of the videoendpoint library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "videoendpoint/v4/";
   ...
   *
   * This request holds the parameters needed by the videoendpoint server.  After setting any optional
   ...
   *
   * This request holds the parameters needed by the videoendpoint server.  After setting any optional
   * parameters, call the {@link GetVideosFromUser#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
   ...
   *
   * This request holds the parameters needed by the videoendpoint server.  After setting any optional
   * parameters, call the {@link ListRecentVideo#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
   ...
   *
   * This request holds the parameters needed by the videoendpoint server.  After setting any optional
   * parameters, call the {@link ListVideo#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
   ...
   *
   * This request holds the parameters needed by the videoendpoint server.  After setting any optional
   * parameters, call the {@link RateVideo#execute()} method to invoke the remote operation.
   *
   * @param id
   * @param likevalue
   * @param viewcount
