 ...
 * on 2014-07-21 at 16:00:52 UTC 
 * Modify at your own risk.
 */

package com.snoozi.userendpoint;

/**
 * Service definition for Userendpoint (v3).
 *
 * <p>
 * This is an API
 * </p>
...
public class Userendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "userendpoint/v3/";
  ...
  /**
   * Create a request for the method "addUserview".
   *
   * This request holds the parameters needed by the userendpoint server.  After setting any optional
   * parameters, call the {@link AddUserview#execute()} method to invoke the remote operation.
   *
   * @param id
   * @param viewcount
   * @return the request
   */
  public AddUserview addUserview(java.lang.Long id, java.lang.Integer viewcount) throws java.io.IOException {
    AddUserview result = new AddUserview(id, viewcount);
    initialize(result);
    return result;
  }

  public class AddUserview extends UserendpointRequest<com.snoozi.userendpoint.model.User> {

    private static final String REST_PATH = "addUserview";

    /**
     * Create a request for the method "addUserview".
     *
     * This request holds the parameters needed by the the userendpoint server.  After setting any
     * optional parameters, call the {@link AddUserview#execute()} method to invoke the remote
     * operation. <p> {@link
     * AddUserview#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     ...
     * @since 1.13
     */
    protected AddUserview(java.lang.Long id, java.lang.Integer viewcount) {
      super(Userendpoint.this, "PUT", REST_PATH, null, com.snoozi.userendpoint.model.User.class);
    ...
    @Override
    public AddUserview setAlt(java.lang.String alt) {
      return (AddUserview) super.setAlt(alt);
    }

    @Override
    public AddUserview setFields(java.lang.String fields) {
      return (AddUserview) super.setFields(fields);
    }

    @Override
    public AddUserview setKey(java.lang.String key) {
      return (AddUserview) super.setKey(key);
    }

    @Override
    public AddUserview setOauthToken(java.lang.String oauthToken) {
      return (AddUserview) super.setOauthToken(oauthToken);
    }

    @Override
    public AddUserview setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (AddUserview) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public AddUserview setQuotaUser(java.lang.String quotaUser) {
      return (AddUserview) super.setQuotaUser(quotaUser);
    }

    @Override
    public AddUserview setUserIp(java.lang.String userIp) {
      return (AddUserview) super.setUserIp(userIp);
    }
    ...
    public AddUserview setId(java.lang.Long id) {
      this.id = id;
      return this;
    }
    ...
    public AddUserview setViewcount(java.lang.Integer viewcount) {
      this.viewcount = viewcount;
      return this;
    }

    @Override
    public AddUserview set(String parameterName, Object value) {
      return (AddUserview) super.set(parameterName, value);
    }
  }
  ...
  public class GetUser extends UserendpointRequest<com.snoozi.userendpoint.model.User> {
    ...
    protected GetUser(java.lang.Long id) {
      super(Userendpoint.this, "GET", REST_PATH, null, com.snoozi.userendpoint.model.User.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
  ...
  public class GetUserByEmail extends UserendpointRequest<com.snoozi.userendpoint.model.User> {

    private static final String REST_PATH = "getUserByEmail";
   ...
   *
   * @param content the {@link com.snoozi.userendpoint.model.User}
   * @return the request
   */
  public InsertUser insertUser(com.snoozi.userendpoint.model.User content) throws java.io.IOException {
    InsertUser result = new InsertUser(content);
    initialize(result);
    return result;
  }

  public class InsertUser extends UserendpointRequest<com.snoozi.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected InsertUser(com.snoozi.userendpoint.model.User content) {
      super(Userendpoint.this, "POST", REST_PATH, content, com.snoozi.userendpoint.model.User.class);
    }
  ...
  public class ListUser extends UserendpointRequest<com.snoozi.userendpoint.model.CollectionResponseUser> {
     ...
     */
    protected ListUser() {
      super(Userendpoint.this, "GET", REST_PATH, null, com.snoozi.userendpoint.model.CollectionResponseUser.class);
    }
   ...
   * @return the request
   */
  public UpdateUser updateUser(com.snoozi.userendpoint.model.User content) throws java.io.IOException {
    UpdateUser result = new UpdateUser(content);
    initialize(result);
    return result;
  }

  public class UpdateUser extends UserendpointRequest<com.snoozi.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected UpdateUser(com.snoozi.userendpoint.model.User content) {
      super(Userendpoint.this, "PUT", REST_PATH, content, com.snoozi.userendpoint.model.User.class);
    }
  ...
  /**
   * Create a request for the method "wakeupUser".
   *
   * This request holds the parameters needed by the userendpoint server.  After setting any optional
   * parameters, call the {@link WakeupUser#execute()} method to invoke the remote operation.
   *
   * @param id
   * @return the request
   */
  public WakeupUser wakeupUser(java.lang.Long id) throws java.io.IOException {
    WakeupUser result = new WakeupUser(id);
    initialize(result);
    return result;
  }

  public class WakeupUser extends UserendpointRequest<com.snoozi.userendpoint.model.User> {

    private static final String REST_PATH = "wakeupUser";

    /**
     * Create a request for the method "wakeupUser".
     *
     * This request holds the parameters needed by the the userendpoint server.  After setting any
     * optional parameters, call the {@link WakeupUser#execute()} method to invoke the remote
     * operation. <p> {@link
     * WakeupUser#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param id
     * @since 1.13
     */
    protected WakeupUser(java.lang.Long id) {
      super(Userendpoint.this, "PUT", REST_PATH, null, com.snoozi.userendpoint.model.User.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }

    @Override
    public WakeupUser setAlt(java.lang.String alt) {
      return (WakeupUser) super.setAlt(alt);
    }

    @Override
    public WakeupUser setFields(java.lang.String fields) {
      return (WakeupUser) super.setFields(fields);
    }

    @Override
    public WakeupUser setKey(java.lang.String key) {
      return (WakeupUser) super.setKey(key);
    }

    @Override
    public WakeupUser setOauthToken(java.lang.String oauthToken) {
      return (WakeupUser) super.setOauthToken(oauthToken);
    }

    @Override
    public WakeupUser setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (WakeupUser) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public WakeupUser setQuotaUser(java.lang.String quotaUser) {
      return (WakeupUser) super.setQuotaUser(quotaUser);
    }

    @Override
    public WakeupUser setUserIp(java.lang.String userIp) {
      return (WakeupUser) super.setUserIp(userIp);
    }
    ...
    public WakeupUser setId(java.lang.Long id) {
      this.id = id;
      return this;
    }

    @Override
    public WakeupUser set(String parameterName, Object value) {
      return (WakeupUser) super.set(parameterName, value);
    }
  }
