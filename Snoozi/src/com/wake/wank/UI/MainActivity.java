...
public class MainActivity extends Activity {
	...
	private void createDummyVideo()
	{
		...
		videoObj.setVideoid(1L); // video id on the Cloud Storage for tracking like/view and others...
		videoObj.setDescription("It's time to wake up !");
		...
		videoObj.setVideoid(2L); // video id on the Cloud Storage for tracking like/view and others...
