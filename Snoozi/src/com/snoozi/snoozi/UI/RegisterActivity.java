...
import com.snoozi.messageEndpoint.MessageEndpoint;
...
public class RegisterActivity extends Activity {
  ...
  private OnTouchListener addUserEventListener = null;
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    Button addUserEventButton = (Button) findViewById(R.id.BtnDone);
    ...
    addUserEventListener = new OnTouchListener() {
    ...
    addUserEventButton.setOnTouchListener(addUserEventListener);
